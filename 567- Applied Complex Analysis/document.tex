...
\title{Resu}                               % optional, remove / comment the line if not wanted
\address{Direcn}{CP, Ciudad}{Pa}% optional, remove / comment the line if not wanted; the "postcode city" and and "country" arguments can be omitted or provided empty
