...
\begin{frame}{movie}
	\begin{figure}[h!]
		...
		{\includegraphics[width=1.0\textwidth]{485.png}}{alpha2.avi}
		\caption{caption}
	\end{figure} 
\end{frame}
...
\begin{frame}{movie}
	\begin{figure}[h!]
		...
		\movie[label=show3,width=1.0\textwidth,poster
		,autostart,showcontrols,loop] 
		{\includegraphics[width=1.0\textwidth]{485.png}}{sineframes.avi}
		\caption{caption}
	\end{figure} 
\end{frame}
...
\begin{frame}{movie}
\begin{figure}[ht]
	\includemovie[poster,text={\small(Loading Video...)}]{6cm}{4cm}{sines.avi}
\end{figure}
\end{frame}
\begin{frame}{Asymptotic behaviour of $u_s$}
  \begin{center}
